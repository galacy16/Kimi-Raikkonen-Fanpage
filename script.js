    ...
    var Tooltip = /*#__PURE__*/ (function (_BaseComponent) {
        ...
        _proto.toggle = function toggle(event) {
            ...
            if (event) {
                ...
                if (
                    this.getTipElement().classList.contains(CLASS_NAME_SHOW$4)
                ) {
        ...
        _proto._initializeOnDelegatedTarget =
            function _initializeOnDelegatedTarget(event, context) {
    ...
    var Tab = /*#__PURE__*/ (function (_BaseComponent) {
        ...
        _proto._activate = function _activate(element, container, callback) {
            ...
            var isTransitioning =
                callback &&
                active &&
                active.classList.contains(CLASS_NAME_FADE$4);
